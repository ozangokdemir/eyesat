...
CY_ISR(I2CS_I2C_ISR)
{
    ...
    #if(I2CS_CHECK_I2C_ACCEPT_ADDRESS_CONST)
        uint32 address;
    #endif /* (I2CS_CHECK_I2C_ACCEPT_ADDRESS_CONST) */
                ...
                if(I2CS_CHECK_I2C_FSM_DATA) /* Data phase */
                {
                    if(I2CS_CHECK_I2C_FSM_RD) /* Reading */
                    {
                        ...
                        */
                        if(I2CS_CHECK_INTR_RX_MASKED(I2CS_INTR_RX_FULL))
                        {
                            ...
                            if(diffCount > I2CS_FIFO_SIZE)
                            {
                                diffCount = I2CS_FIFO_SIZE;
                            }
                            else
                            {
                                if(0u == diffCount)
                    ...
                    else /* Writing */
                    {
                        ...
                        */
                        ...
                        {
                            while(I2CS_FIFO_SIZE != I2CS_GET_TX_FIFO_ENTRIES)
                            {
        ...
        #if(I2CS_I2C_SLAVE)
        {
            ...
            */
            if(I2CS_CHECK_INTR_SLAVE_MASKED(I2CS_INTR_SLAVE_I2C_ADDR_MATCH))
            {
                #if(I2CS_CHECK_I2C_ACCEPT_ADDRESS)
                {
                    address = I2CS_RX_FIFO_RD_REG; /* Address in the RX FIFO */
            ...
            */
            if(I2CS_CHECK_INTR_RX_MASKED(I2CS_INTR_RX_FULL))
            {
                ...
                diffCount =  I2CS_slWrBufSize -
                            (I2CS_slWrBufIndex + I2CS_FIFO_SIZE);

                if(diffCount > I2CS_FIFO_SIZE) /* Proceed transaction */
                {
                    diffCount   = I2CS_FIFO_SIZE;
                    endTransfer = 0u;  /* Continue active transfer */
                }
                ...
                while(I2CS_FIFO_SIZE != I2CS_GET_TX_FIFO_ENTRIES)
                {
                    ...
                    */
                    ...
                    /* Probably Overflow */
                    {
                        ...
                        if(0u == (I2CS_INTR_TX_OVERFLOW & I2CS_slOverFlowCount))
                        {
