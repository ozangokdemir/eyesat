...
uint8 I2CS_initVar = 0u;
    ...
    cyisraddress I2CS_customIntrHandler = NULL;
...
void I2CS_Init(void)
{
    ...
    {
        I2CS_initVar = 0u; /* Clear init var */
    }
    else
    {
...
void I2CS_Stop(void)
{
    ...
    I2CS_ScbModeStop(); /* Calls scbMode specific Stop function */
}
...
static void I2CS_ScbModeStop(void)
{
    ...
    *
    *******************************************************************************/
    void I2CS_SetPins(uint32 mode, uint32 subMode, uint32 uartTxRx)
    {
        ...
        {
            hsiomSel[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_HSIOM_I2C_SEL;
            hsiomSel[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_HSIOM_I2C_SEL;

            pinsDm[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
            pinsDm[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        }
    #if(!I2CS_CY_SCBIP_V1_I2C_ONLY)
        else if(I2CS_SCB_MODE_SPI == mode)
        {
            hsiomSel[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_HSIOM_SPI_SEL;
            hsiomSel[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_HSIOM_SPI_SEL;
            hsiomSel[I2CS_SCLK_PIN_INDEX]        = I2CS_HSIOM_SPI_SEL;

            if(I2CS_SPI_SLAVE == subMode)
            {
                /* Slave */
                pinsDm[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                pinsDm[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= I2CS_MISO_SDA_TX_PIN_MASK;
            #endif /* (I2CS_MISO_SDA_TX_PIN_PIN) */
            }
            else /* (Master) */
            {
                pinsDm[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                pinsDm[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                ...
                pinsInBuf |= I2CS_MOSI_SCL_RX_PIN_MASK;
            #endif /* (I2CS_MOSI_SCL_RX_PIN) */

             #if(I2CS_MOSI_SCL_RX_WAKE_PIN)
                pinsInBuf |= I2CS_MOSI_SCL_RX_WAKE_PIN_MASK;
            #endif /* (I2CS_MOSI_SCL_RX_WAKE_PIN) */
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_HSIOM_UART_SEL;
                pinsDm  [I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                if(0u != (I2CS_UART_RX & uartTxRx))
                {
                    hsiomSel[I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_HSIOM_UART_SEL;
                    pinsDm  [I2CS_MOSI_SCL_RX_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                }

                if(0u != (I2CS_UART_TX & uartTxRx))
                {
                    hsiomSel[I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_HSIOM_UART_SEL;
                    pinsDm  [I2CS_MISO_SDA_TX_PIN_INDEX] = I2CS_PIN_DM_STRONG;
    ...
    #if(I2CS_MOSI_SCL_RX_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_MOSI_SCL_RX_HSIOM_REG,
                                       I2CS_MOSI_SCL_RX_HSIOM_MASK,
                                       I2CS_MOSI_SCL_RX_HSIOM_POS,
                                       hsiomSel[I2CS_MOSI_SCL_RX_PIN_INDEX]);

        I2CS_spi_mosi_i2c_scl_uart_rx_SetDriveMode((uint8) pinsDm[I2CS_MOSI_SCL_RX_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_spi_mosi_i2c_scl_uart_rx_INP_DIS,
                                     I2CS_spi_mosi_i2c_scl_uart_rx_MASK,
                                     (0u != (pinsInBuf & I2CS_MOSI_SCL_RX_PIN_MASK)));
    #endif /* (I2CS_MOSI_SCL_RX_PIN) */

    #if(I2CS_MOSI_SCL_RX_WAKE_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_MOSI_SCL_RX_WAKE_HSIOM_REG,
                                       I2CS_MOSI_SCL_RX_WAKE_HSIOM_MASK,
                                       I2CS_MOSI_SCL_RX_WAKE_HSIOM_POS,
                                       hsiomSel[I2CS_MOSI_SCL_RX_WAKE_PIN_INDEX]);

        I2CS_spi_mosi_i2c_scl_uart_rx_wake_SetDriveMode((uint8)
                                                               pinsDm[I2CS_MOSI_SCL_RX_WAKE_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_spi_mosi_i2c_scl_uart_rx_wake_INP_DIS,
                                     I2CS_spi_mosi_i2c_scl_uart_rx_wake_MASK,
                                     (0u != (pinsInBuf & I2CS_MOSI_SCL_RX_WAKE_PIN_MASK)));

         /* Set interrupt on falling edge */
        I2CS_SET_INCFG_TYPE(I2CS_MOSI_SCL_RX_WAKE_INTCFG_REG,
                                        I2CS_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK,
                                        I2CS_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS,
                                        I2CS_INTCFG_TYPE_FALLING_EDGE);
    #endif /* (I2CS_MOSI_SCL_RX_WAKE_PIN) */

    #if(I2CS_MISO_SDA_TX_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_MISO_SDA_TX_HSIOM_REG,
                                       I2CS_MISO_SDA_TX_HSIOM_MASK,
                                       I2CS_MISO_SDA_TX_HSIOM_POS,
                                       hsiomSel[I2CS_MISO_SDA_TX_PIN_INDEX]);

        I2CS_spi_miso_i2c_sda_uart_tx_SetDriveMode((uint8) pinsDm[I2CS_MISO_SDA_TX_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_spi_miso_i2c_sda_uart_tx_INP_DIS,
                                     I2CS_spi_miso_i2c_sda_uart_tx_MASK,
                                    (0u != (pinsInBuf & I2CS_MISO_SDA_TX_PIN_MASK)));
    #endif /* (I2CS_MOSI_SCL_RX_PIN) */

    #if(I2CS_SCLK_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SCLK_HSIOM_REG, I2CS_SCLK_HSIOM_MASK,
                                       I2CS_SCLK_HSIOM_POS, hsiomSel[I2CS_SCLK_PIN_INDEX]);
    ...
    #if(I2CS_SS0_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SS0_HSIOM_REG, I2CS_SS0_HSIOM_MASK,
                                       I2CS_SS0_HSIOM_POS, hsiomSel[I2CS_SS0_PIN_INDEX]);
    ...
    #if(I2CS_SS1_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SS1_HSIOM_REG, I2CS_SS1_HSIOM_MASK,
                                       I2CS_SS1_HSIOM_POS, hsiomSel[I2CS_SS1_PIN_INDEX]);
    ...
    #if(I2CS_SS2_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SS2_HSIOM_REG, I2CS_SS2_HSIOM_MASK,
                                       I2CS_SS2_HSIOM_POS, hsiomSel[I2CS_SS2_PIN_INDEX]);
    ...
    #if(I2CS_SS3_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SS3_HSIOM_REG,  I2CS_SS3_HSIOM_MASK,
                                       I2CS_SS3_HSIOM_POS, hsiomSel[I2CS_SS3_PIN_INDEX]);
