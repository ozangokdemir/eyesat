...
#define M1_DM_ALG_HIZ         (0x00u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_DIG_HIZ         (0x01u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_RES_UP          (0x02u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_RES_DWN         (0x03u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_OD_LO           (0x04u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_OD_HI           (0x05u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_STRONG          (0x06u << M1_DRIVE_MODE_SHIFT)
#define M1_DM_RES_UPDWN       (0x07u << M1_DRIVE_MODE_SHIFT)
